...
#convert categories into arrays - don't do
...
tfidf_matrix = vectorizer.fit_transform(data['lemma abstract'])
features = vectorizer.get_feature_names_out()

#TODO: normalize # of vectors within each row
#QUESTION: do we need to do this if we over/under sample the # of articles between each categories? 

#split into test and train data
X = tfidf_matrix #QUESTION: How is the relationship between words and y-target captured? 
